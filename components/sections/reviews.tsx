...
function ReviewPlatformBadge({ platform }: { platform: ReviewPlatform }) {
  ...
  return (
    <a
      ...
      className="review-platform flex w-full md:w-auto items-center gap-3 border border-border bg-white px-4 py-3 h-[72px] transition-colors hover:bg-white"
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src={platform.logo} alt={platform.name} className="h-8 w-auto shrink-0 object-contain" />
